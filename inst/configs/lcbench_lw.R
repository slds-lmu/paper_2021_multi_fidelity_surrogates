...
# Param Set
# log scale: batch_size, learning_rate, max_units
...
target_variables = c("val_accuracy", "time") 
# val_accuracy could also be one of val_cross_entropy, val_balanced_accuracy, test_cross_entropy, test_balanced_accurac
