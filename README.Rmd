...
dt = data.frame(
  instance = c("NB301", "LCBench", "RBv2SVM", "RBv2rpart", "RBv2aknn",
               "RBv2glmnet", "RBv2ranger", "RBv2xgboost", "FCNet"),
  space = c("Cat+Dep", "Mix", "Mix+Dep", "Mix", "Mix", "Mix", "Mix+Dep",
            "Mix+Dep", "Mix"),
  n_dims = c(34L, 7L, 7L, 5L, 6L, 3L, 9L, 14L, 11L),
  n_targets = c(2L, 6L, 4L, 4L, 4L, 4L, 4L, 4L, 4L),
  fidelity = c("epochs", "epoch", "NA", "NA", "NA", "NA", "NA", "NA", "epochs + repls"),
  n_problems = c(1L, 35L, 98L, 22L, 33L, 56L, 114L, 119L, 4L),
  "$R^2$" = c(0.9866, 0.9820, NA, NA, NA, NA, NA, NA, NA),
  "$R^2$" = c(0.9866, 0.9820, NA, NA, NA, NA, NA, NA, NA),
