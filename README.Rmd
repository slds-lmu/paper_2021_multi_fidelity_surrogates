...
dt = data.frame(
  ...
  n_dims = c(34L, 7L, 7L, 5L, 6L, 3L, 9L, 14L, 36L, 11L, 9L),
  n_targets = c(2L, 6L, 4L, 4L, 4L, 4L, 4L, 4L, 4L, 4L, 4L),
  fidelity = c("epochs", "epoch", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "epochs + repls", "epochs + repls"),
  n_problems = c(1L, 35L, 98L, 22L, 33L, 56L, 114L, 119L, 122L, 4L, 20L),
