...
dt = data.frame(
  ...
  n_dims = c(34L, 7L, 7L, 5L, 6L, 3L, 9L, 14L, 36L, 10L, 9L),
  n_targets = c("2:perf(1)+rt", "6:perf(5)+rt","6:perf(4)+rt+pt","6:perf(4)+rt+pt","6:perf(4)+rt+pt", "6:perf(4)+rt+pt","6:perf(4)+rt+pt","6:perf(4)+rt+pt","6:perf(4)+rt+pt", "3:perf(1)+rt+ms", "4:perf(4)"),
  fidelity = c("epochs", "epochs", "frac+repls", "frac+repls", "frac+repls", "frac+repls", "frac+repls", "frac+repls", "frac+repls", "epochs", "epochs+repls"),
  n_problems = c(1L, 35L, 96L, 101L, 99L, 98L, 114L, 109L, 89L, 4L, 20L),
  "$R^2$" = c(0.9866, 0.9820, 0.69, 0.34, 0.368, 0.259, 0.283, 0.577,  NA, 0.769, -44),
