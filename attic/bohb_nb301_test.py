...
class nb301(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        config.update({"epoch": budget})  # FIXME: budget trafo to match epoch range and int
        ...
        return({
                    'val acc': float(res[0,0]),  # this is the a mandatory field to run hyperband
